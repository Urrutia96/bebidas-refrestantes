<template>
  <div class="bg-white rounded-xl">
    <div class="relative">
      <img class="object-center w-full h-48 rounded-xl" src="https://images.unsplash.com/photo-1584013286182-be9df31899bb?ixlib=rb-1.2.1&auto=format&fit=crop&w=1052&q=80" alt="IceCream">
      <button class="absolute top-0 right-0 mt-5 mr-5 bg-white rounded-full p-2 ">
    ...
    <div class="px-4 py-4">
      <span class="text-gray-800 text-xl font-semibold">Stranberry and Blue</span>
      <p class="text-gray-600 font-hairline text-sm">Lorem ipsum, dolor sit amet consectetur adipisicing elit</p>
      <div class="mt-3 flex justify-between items-center">
        <span class="text-main text-2xl font-semibold">$15.00 us</span>
        <button @click="$emit('toggle-sidebar')" class="p-2 rounded-full bg-main hover:bg-opacity-50">
          <svg class="fill-current text-white h-6 w-6" width="31" height="31" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M12.3618 25.6704L11.0222 17.7175C10.939 17.2227 10.4699 16.8892 9.97569 16.9726C9.48102 17.0559 9.14759 17.5245 9.2309 18.0192L10.5705 25.9721C10.6452 26.4157 11.0297 26.7296 11.465 26.7296C11.5151 26.7296 11.5659 26.7255 11.6169 26.7169C12.1117 26.6336 12.4451 26.165 12.3618 25.6704Z" fill="white"/>
            <path d="M20.8823 16.9726C20.3882 16.8897 19.9192 17.2227 19.8358 17.7175L18.4962 25.6704C18.413 26.165 18.7464 26.6335 19.2411 26.7169C19.2921 26.7255 19.3429 26.7296 19.393 26.7296C19.8283 26.7296 20.2129 26.4157 20.2875 25.9721L21.6271 18.0192C21.7105 17.5245 21.377 17.0559 20.8823 16.9726Z" fill="white"/>
          </svg>
        </button>
      </div>
    </div>
